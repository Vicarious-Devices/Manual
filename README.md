...
- We need to move from a world of cumbersome, dystopian forms of immersive experience that are unable to fit into the world we live in, to seamless architectures that improve our quality of life and make people more productive.
...
##### [Vicarious Devices Corporation](https://www.vicariousdevices.com/) is an early-stage startup company founded in 2025. We develop hardware and software architectures for new mediums of immersive reality, capable of the long-term succession of modern reality interfaces. We see the challenges ahead of us not as barriers, but as invitations to create enduring solutions that have the ability to alter how we perceive the physical world. Our architectures are designed to render alternative interface approaches impractical by comparison. We do see our architectures as a template for others to follow — hence our existence on this site — and we invite others to follow. We work to introduce technologies that displace weight such that our industry advances as a whole.
...
### Contributions
##### TBD (Capital)
##### C. LaRosa (Prowess) - [X](https://twitter.com/ctlrsa); [LI](https://www.linkedin.com/in/ctlrsa/); [Blog](https://medium.com/@ctlrsa)
